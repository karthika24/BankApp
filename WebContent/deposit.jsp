	...
	<form method="post" action="Deposit">
		<div class="center">
			<div class="form-group">
				<h1>
					<label for="inputdefault">Enter Pin</label>
				</h1>
				<input class="form-control" id="inputdefault" type="password"
					name="pin" pattern="[1-9]{4}" maxlength="4" required>
			</div>
			<div class="form-group">
				<h1>
			...
			<div class="form-group">
				<h1>
					<label for="inputdefault">Enter Amount</label>
				</h1>
				<input class="form-control" id="inputdefault" type="number"
					step="0.01" min="1" name="amount" required>
			</div>
			<h2>
